package com.zalo.servicetraining.fundamental.servicedemo.service;
...
public class TimeTrackService extends Service {
    ...
    public static final String PACKAGE_NAME = "com.zalo.servicetraining.fundamental.servicedemo.mService";

    static final int NOTIFICATION_ID = 1;
    static final String NOTIFICATION_CHANNEL_ID = "time_listening_notification";
    public static final String ACTION_NOTIFY_TIME = "com.zalo.servicetraining.mService.ACTION_NOTIFY_TIME";
    public static final String ACTION_NOTIFY_STOP = "com.zalo.servicetraining.mService.ACTION_NOTIFY_STOP";
