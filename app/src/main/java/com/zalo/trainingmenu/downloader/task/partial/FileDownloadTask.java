...
public class FileDownloadTask extends BaseTask<PartialTaskManager> {
    ...
    private FileDownloadTask(int id, PartialTaskManager taskManager, String directory, String url, long createdTime, String fileTitle, boolean isAutoGeneratedPath, boolean isAutoGeneratedTitle) {
