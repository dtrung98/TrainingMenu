...
public class NewsFeed3DActivity extends AbsListActivity {
    ...
    protected void refreshData() {
        ...
        list.add(new NewsFeedObject().setContentText("A ball").setImageObject(new ParallaxImageObject(BitmapFactory.decodeFile("/storage/emulated/0/Download/ball.jpg"),BitmapFactory.decodeFile("/storage/emulated/0/Download/ball_depth.jpg"))));
        list.add(new NewsFeedObject().setContentText("Canyon").setImageObject(new ParallaxImageObject(BitmapFactory.decodeFile("/storage/emulated/0/Download/canyon.jpg"),BitmapFactory.decodeFile("/storage/emulated/0/Download/canyon_depth.jpg"))));
        list.add(new NewsFeedObject().setContentText("Lady").setImageObject(new ParallaxImageObject(BitmapFactory.decodeFile("/storage/emulated/0/Download/lady.jpg"),BitmapFactory.decodeFile("/storage/emulated/0/Download/lady_depth.jpg"))));
        list.add(new NewsFeedObject().setContentText("Another mountain").setImageObject(new ParallaxImageObject(BitmapFactory.decodeFile("/storage/emulated/0/Download/mount.jpg"), BitmapFactory.decodeFile("/storage/emulated/0/Download/mount-map.jpg"))));
